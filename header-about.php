...
<body>
	<div id="wrapper">
		...
		<header id="header" class="child_header_wrap header_about_us">
			<div id="about_header" class="child_header">
				<div>
			...
			<section class="contents_wrap">
				<p>Global Innovation Support Communication</p>
				<h2>株式会社Gisucoは「共同経営精神」を掲げ、企業に対し多様な<br/>
				サポートをする会社として設立いたしました｡</h2>
			</section>
		</header><!-- ヘッダーここまで -->
=======
<!doctype html>
